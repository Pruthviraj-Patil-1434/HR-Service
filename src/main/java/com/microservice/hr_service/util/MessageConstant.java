...
public class MessageConstant {
    ...
    public static final String USER_NOT_FOUND_WITH_IDENTIFIER = "Invalid email.Please check your email and try again.";
    ...
    public static final String ACCESS_TOKEN_REFRESHED_SUCESSFULLY = "Accessp token refreshed successfully";
    ...
    public static final String INVALID_USERNAME_OR_PASSWORD_OR_HRCODE = "Invalid Password or HR code";
    public static final String INVALID_CLIENT_CODE = "Invalid HR code";
